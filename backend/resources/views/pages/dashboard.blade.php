...
<div class="content-header">
    <div class="container-fluid">
        <div class="row mb-2">
            <div class="col-sm-6">
                <h1 class="text-title m-0"> <strong>Dashboard</strong></h1>
                @if(session('success'))
...
<section class="content">
    <div class="container-fluid">
        ...
        <div class="row">
            ...
            <div class="col-lg-3 col-6">
                ...
                <div class="small-box bg-warning">
                    <div class="inner">
                        <h3 style="color: white;">{{$portofolioData}}</h3>
                        <p style="color: white;">Portofolio</p>
                    </div>
                    <div class="icon">
                        <i class="fas fa-file-alt"></i>
                    </div>
                    <a href="{{route('show-portofolio')}}" class="small-box-footer" style="color:white;">More info <i class="fas fa-arrow-circle-right"></i></a>
                </div>
            </div>
            <!-- ./col -->
            <div class="col-lg-3 col-6">
        ...
        <div class="row">
            ...
            <section class="    -lg-5 connectedSortable">
