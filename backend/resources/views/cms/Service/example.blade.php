            ...
            <form action="{{ route('show-product') }}" method="GET">
                ...
                <div class="input-group" style="width: 100%;">
                    ...
                    @if(auth()->user()->role->role_name !== 'HCM')
                        <a href="{{ route('pruduct-create') }}" class="btn btn-success ml-5">Add Service</a>
                    @else
            ...
            @foreach($products as $product)
                <div class="service-card">
                    <div class="d-flex align-items-center m-4">
                        <div>
                            <h4 class="service-name text-bold">{{ $product->name }}</h4>
                        ...
                        <img class="service-img" src="{{asset($product->image)}}" alt="gagal">
                    </div>
